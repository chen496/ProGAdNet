...
nrepeat=50; 
for T=1:6 % T=1,2,3,4,5 means N is 80,100,150,200,250,300
path_data=['C:\Users\Administrator\Desktop\Simulation I Linear Regression Model\data_n\k',num2str(T)];
mkdir(path_data)
n=N(T);
s=zeros(nrepeat ,6);
