...
%%n=113, p=4310%%
clear;
fprintf('Make sure the "BRCA_gene_exp_tumor.txt" and "BRCA_gene_exp_normal.txt" network is in the same path..\n\n');
%%please put the gene_exp_1.txt and gene_exp_2.txt into this fold%%
load BRCA_gene_exp_tumor.txt
load BRCA_gene_exp_normal.txt
X1 = BRCA_gene_exp_tumor';
X2 = BRCA_gene_exp_normal';
