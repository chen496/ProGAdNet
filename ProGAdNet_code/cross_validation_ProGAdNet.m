function [lambda1,lambda2_mat,twoSE_step1,twoSE_step2,best_point,best_step1,best_step2,CVmeanMatrix] = cross_validation_ProGAdNet(y1,x1,y2,x2,STEP1,STEP2,num_folds)
